...
import { addTodo, fetchTodos, getTodosFromLocalStorage } from '../redux/todos/actions';
            ...
            <div style={{ height: '200px', overflow: 'scroll' }}>
                {fetch_todos_pending ? 'Loading...' :
                    fetch_todos?.map((item, index) => {
                        return <>
                            <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={() => dispatch(addTodo(item))}>Add</button>
